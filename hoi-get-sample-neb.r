...
# considering week 0
dataOut <-read.table("1-neb0.csv",sep=",")
...
dataOut <-read.table("1-neb.csv",sep=",")
colnames(dataOut) <- c("week", "replicate", "x1")
...
summary(as.numeric(df_pars$y0))
summary(as.numeric(df_pars$r))
summary(as.numeric(df_pars$K))
